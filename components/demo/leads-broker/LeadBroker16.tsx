...
export default LeadCreator16;

function LeadCreator16({ onClickOutside, modalPanel16ShowHandler }) {
      ...
      <>
        <div
          className={`layoutModal ${
            modalPanel16ShowHandler ? "d-block modal-open" : "d-none"
          }`}
        >
                      ...
                      <div className="modal-body my-2 ">
                        <div>
                          <div className="banner-creditcard">
                            <img
                              src="https://www.nicepng.com/png/detail/254-2542614_social-media-links-visa-mastercard-accepted-banner-sign.png"
                              alt=""
                            />
                          </div>
                          <div className="d-flex justify-content-around ">
