...
export default LeadCreator19;

function LeadCreator19({ onClickOutside, modalPanel19ShowHandler }) {
      ...
      <>
        <div
          className={`layoutModal ${
            modalPanel19ShowHandler ? "d-block modal-open" : "d-none"
          }`}
        >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <div className="d-flex justify-content-center">
                        ...
                        >
                          ...
                          SOLICITAR MOVIMIENTO A ASEGURADORA
                        </button>
                        <br></br>
                      </div>
                      <div className="d-flex justify-content-center">
