...
<div className="form-group">
  ...
  <tbody>
    <tr>
      ...
      <td className="opacity-0" > <input type="button"  value="Seleccionar archivo" className="archive-select" /></td>
        
        <td > <input type="button"  value="Seleccionar archivo" className="archive-select" /></td>
        <td>
                  motivo
        </td>
