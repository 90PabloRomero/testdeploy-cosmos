...
export default LeadCreator11;

function LeadCreator11({ onClickOutside,modalPanel11ShowHandler }) {
    ...
    <>
      ...
      <div
        className={`layoutModal ${
          modalPanel11ShowHandler ? "d-block modal-open" : "d-none"
        }`}
      >
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="modal-body my-2">
                  ...
                  <div className="d-flex justify-content-center">
                    ...
                    <div className="form-group">
                      <button className="btn btn-primary select-product">
                        {formState.isSubmitting && (
                          <span className="spinner-border spinner-border-sm mr-1"></span>
                        )}
                        Firmar Requisitos
              ...
              <div className="d-flex">
                <div className="notes-n">
                  <p>
                    ...
                    Atque voluptas error in ipsam voluptatum ex eum. Perferendis
                    eaque nisi, a cupiditate natus eveniet exercitationem,
                    nostrum necessitatibus voluptatem voluptate hic. Vitae.
                  </p>
