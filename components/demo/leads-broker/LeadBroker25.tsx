...
export default LeadCreator25;

function LeadCreator25({ onClickOutside, modalPanel25ShowHandler }) {
      ...
      <>
        <div
          className={`layoutModal ${
            modalPanel25ShowHandler ? "d-block modal-open" : "d-none"
          }`}
        >
                        ...
                        <div className="d-flex justify-content-around ">
                          <div className="form-group ">
                            <input
                              ...
                              type="text"
                              className={`form-control  notes-area`}
                              placeholder="descripción de la solicitud de alcance"
                            />
                          </div>
                        </div>
                      </div>
