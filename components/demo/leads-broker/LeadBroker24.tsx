...
export default LeadCreator24;

function LeadCreator24({ onClickOutside, modalPanel24ShowHandler }) {
      ...
      <>
        <div
          className={`layoutModal ${
            modalPanel24ShowHandler ? "d-block modal-open" : "d-none"
          }`}
        >
  ...
  indemnización - <span> Revisión Liquidación de Siniestros</span>
            </div>
  <div>Poliza</div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      <div className="modal-body my-2 bg-grey ">
                        <div className="d-flex ">
                          ...
                          <div className="form-group txt-align-ct pt-auto"></div>
                          <div className="form-group txt-align-ct pt-auto btn-archive ">
                            <button
                              disabled={formState.isSubmitting}
                              className="btn btn-primary "
                      ...
                      <div className="d-flex justify-content-center">
                        <button
                          disabled={formState.isSubmitting}
                          className="btn btn-primary bg-red ml-10"
                        >
                          {formState.isSubmitting && (
                            <span className="spinner-border spinner-border-sm mr-1 "></span>
                          )}
                          LIQUIDACION NO ACEPTADA
                        </button>
                        <button
                          disabled={formState.isSubmitting}
                          className="btn btn-primary ml-10 bg-green"
                        >
                          {formState.isSubmitting && (
                            <span className="spinner-border spinner-border-sm mr-1 "></span>
                          )}
                          LIQUIDACION ACEPTADA
                        </button>
